...
function UpdateUnitMenu(propMenu, unitMenu) {
  // Updating the units displayed in the unitMenu according to the selection of property in the propMenu.
  var i;
...
function ConvertFromTo(sourceForm, targetForm) {
  ...
  // Starting by checking which property we are working in...
  ...
  // a) converting the source TO the base unit: (The input has been checked by the CalculateUnit function).
